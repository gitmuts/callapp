...
while ($row = mysqli_fetch_array($query)) {
    ...
    try {
        ...
        if (mysqli_num_rows($check_blacklist) < 1) {
            ...
            $sql1 = mysqli_query($con, "INSERT INTO tapp_voice_broadcast_logs(twilio_number,user_number,voice_file,recording_url,agent_number,is_called,date_time) VALUES ('" . $caller_id . "','" . $user_number . "','" . $voice_file . "','no','" . $agent_number . "','no',now())");
            if ($sql1) {
