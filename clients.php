...
<head>
    <style>
        #call_button {
            background-color: #0c8d43 !important;
        ...
        <div class="container-fluid">
            ...
            <div class="animated fadeIn">
                    ...
                    <div class="card-header">
                        ...
                        <div class="modal fade" id="add_form">
                            ...
                            <div class="modal-dialog">
                                ...
                                <form class="no-margin" id="formValidate2" data-validate="parsley" method="post"
                                      action="add_new_client.php" name="client_record" enctype="multipart/form-data">
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="email" placeholder="Email" value="" class="form-control  "
                                                       name="email">
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="number" name="mobile" placeholder="Enter Mobile Number"
                                                       value="" class="form-control input-sm parsley-validated"
                                                       required>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" placeholder="Address" value="" class="form-control  "
                                                       name="address">
                                            </div>
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <button type="submit"
                                                    class="btn btn-danger btn-sm check<?php echo $row['id']; ?>">Submit
                                            </button>
                        ...
                        <div class="modal fade" id="add_bulk">
                            ...
                            <div class="modal-dialog">
                                ...
                                <form class="no-margin" id="formValidate2" data-validate="parsley" method="post"
                                      action="import_clients.php" name="client_record" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-9">
                                    ...
                                    <button type="button" class="btn btn-primary" data-toggle="modal"
                                            data-target="#add_form ">Add New Contact
                                    </button>
                                    <button type="button" class="btn btn-primary" data-toggle="modal"
                                            data-target="#add_bulk ">Import excel
                                    </button>
                                    <a href="upload/sample_contact.xlsx" download type="button" class="btn btn-primary"
                                       data-toggle="" data-target="">Sample file
                                    </a>

                                </div>
                                <div class="col-md-3">

                                    <a href="export_clients.php?year=<?php echo $year; ?>&month=<?php echo $month; ?>">
                                        <button type="button" value="Export Data" class="btn btn-primary btn-md"
                                                style="float:right"> Export Data
                                        </button>
                ...
                <i class="fa fa-envelope-open "></i>
                                            ...
                                            <a class="btn btn-info action-btn"
                                               href="#edit_form<?php echo $data1['id']; ?>" data-toggle="modal">
                                            ...
                                            <a class="btn btn-danger action-btn"
                                               href="#delete<?php echo $data1['id']; ?>" data-toggle="modal">
                                    ...
                                    <div class="modal fade" id="edit_form<?php echo $data1['id']; ?>">
                                        <div class="modal-dialog">
                                            <form class="no-margin" id="formValidate2" data-validate="parsley"
                                                  method="post" action="update_client.php" name="client_record"
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" placeholder="Name"
                                                                   value="<?php echo $data1['first_name']; ?>" required
                                                                   class="form-control " name="first_name">
                                                        </div>
                                                    ...
                                                    <div class="modal-footer">
                                                        <button type="submit"
                                                                class="btn btn-danger btn-sm check<?php echo $row['id']; ?>">
                                                            Submit
                                                        </button>
                                                        <button class="btn btn-sm btn-success" data-dismiss="modal"
                                                                aria-hidden="true">Close
                                    ...
                                    <div class="modal fade" id="message_form<?php echo $data1['id']; ?>">
                                        <div class="modal-dialog">
                                            <form class="no-margin" id="formValidate2" data-validate="parsley"
                                                  method="post" action="send_message.php" name="client_record"
                                                  enctype="multipart/form-data">
                                                <input type="hidden" name="" value="<?php echo $data1['id'] ?>">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h4 class="modal-title text-center">Message
                                                            to <?php echo $data1['first_name']; ?></h4>
                                                        <button type="button" class="close" data-dismiss="modal"
                                                                aria-hidden="true">&times;
                                                        </button>
                                                    </div>
                                    ...
                                    <div class="modal fade" id="call_form<?php echo $data1['id']; ?>">
                                        <div class="modal-dialog">
                                            ...
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h4 class="modal-title text-center">Call
                                                        to <?php echo $data1['first_name']; ?></h4>
                                                    <button type="button" class="close" data-dismiss="modal"
                                                            aria-hidden="true">&times;
                                                    </button>
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <button class="call btn btn-lg col-sm-5 " id="call_button"
                                                                onclick="call(<?php echo $data1['id']; ?>);">
                                                        ...
                                                        <button class="hangup btn btn-lg col-sm-6" id="hangup_button"
                                                                onclick="hangup();">
                                                    ...
                                                    <div class="form-group">
                                                        <select name="caller_id" class="form-control"
                                                                id="caller_id<?php echo $data1['id']; ?>">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control enter_call" type="text"
                                                               id="number<?php echo $data1['id']; ?>" name="number"
                                                               value="<?php echo $data1['sender']; ?>" readonly
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <div class="form-group" style="text-align: center;">
                                                            ...
                                                            <label for="folderName">Are you sure you want to remove this
                                                                Contact? This action can't be undone.</label>
