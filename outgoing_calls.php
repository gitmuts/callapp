                ...
                <div class="card-body">
                    ...
                    <div class="row justify-content-center">
                        ...
                        <div class="col-sm-3">
                            ...
                            <button style="display:none" class="hangup btn btn-lg col-sm-9 text-center"
                                    id="hangup_button" onclick="hangup();">
                    ...
                    <div class="row justify-content-center">
                        ...
                        <div class=" col-sm-5">
                            ...
                            <input class="form-control enter_call" type="text" id="number"
                                   onkeyup="check_blacklist(this.value)" name="number"
                    ...
                    <div class="row">
                        ...
                        <div id="log" class="col-sm-3 btn btn-primary text-center" style="background: #20a8d8;">Ready
                        </div>
